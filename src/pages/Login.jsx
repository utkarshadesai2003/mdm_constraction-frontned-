      ...
      <div className="relative flex flex-col items-center justify-center w-full px-6 mx-auto max-w-7xl lg:flex-row lg:justify-between">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4 mt-6 sm:flex-row lg:justify-start">
            <Link
              to="/freetrial"
              className="px-8 py-3 text-lg font-semibold text-center text-white transition shadow-lg rounded-xl bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-500 hover:to-indigo-500"
            >
              Start Free Trial
            </Link>
            ...
            <Link
              to="/"
              className="px-8 py-3 text-lg font-semibold text-center bg-white border shadow transition6 text-blue-00 rounded-xl hover:bg-indigo-50"
            >
              Learn More
            </Link>
          </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full py-3 font-semibold text-white transition rounded-lg shadow bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-600 hover:to-blue-600"
            >
              Login
            </button>
          </form>
